                        ...
                        <div className="flex-1 overflow-y-auto p-4 space-y-4">
                            ...
                            <div className="mb-4">
                                ...
                                >
                                    ...
                                    <div>
                                        <div className="font-bold text-slate-200 text-sm">Modo Cocina</div>
                                        <div className="text-[10px] text-slate-400 font-medium tracking-wide">Recetas, Repartos e Ingredientes</div>
                                    </div>
                                </button>
                            </div>
